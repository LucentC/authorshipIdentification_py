...
d1 = data_warehouse.get_features_from_database_by_doc_id(2013) # 1
feature_list.append(d1)
d2 = data_warehouse.get_features_from_database_by_doc_id(408)
feature_list.append(d2)
d3 = data_warehouse.get_features_from_database_by_doc_id(1400)
feature_list.append(d3)
author_list.extend([0 for x in range(3)])

d4 = data_warehouse.get_features_from_database_by_doc_id(434)
feature_list.append(d4)
d5 = data_warehouse.get_features_from_database_by_doc_id(622)
feature_list.append(d5)
d6 = data_warehouse.get_features_from_database_by_doc_id(660)
feature_list.append(d6)
author_list.extend([1 for x in range(3)])

d7 = data_warehouse.get_features_from_database_by_doc_id(191) # 3
feature_list.append(d7)
d8 = data_warehouse.get_features_from_database_by_doc_id(459)
feature_list.append(d8)
d9 = data_warehouse.get_features_from_database_by_doc_id(468)
