...
try:
    ...
    #cur.execute("SELECT feature_value FROM fact WHERE doc_id = 9 AND para_id = 1617;") #add ordered by feature_id
    ...
    # #cur.execute("SELECT feature_value FROM fact WHERE doc_id = 9 AND para_id = 1618;")
    #
    # rows = cur.fetchall()
    # l2 = []
    # for row in rows:
    ...
    #     l3.append(row[0])
    #
    # cur.execute("SELECT feature_value FROM fact WHERE doc_id = 9 AND (feature_id = 1 OR feature_id = 2 OR feature_id = 3 OR feature_id = 4 OR feature_id = 5 OR feature_id = 16 OR feature_id = 29 OR feature_id = 30);")
    # #cur.execute("SELECT feature_value FROM fact WHERE doc_id = 9;")
    #
    # rows = cur.fetchall()
    # l4 = []
    # l = []
    ...
    #     l.append(row[0])
    #
    # cur.execute("SELECT feature_value FROM fact WHERE doc_id = 11 AND (feature_id = 1 OR feature_id = 2 OR feature_id = 3 OR feature_id = 4 OR feature_id = 5 OR feature_id = 16 OR feature_id = 29 OR feature_id = 30);")
    # #cur.execute("SELECT feature_value FROM fact WHERE doc_id = 11;")
    #
    # rows = cur.fetchall()
    # l5 = []
    # l = []
